...
- [Geo Mashup](http://geomashup.org/?utm_source=snazzymaps&utm_medium=plugin&utm_campaign=partners)
...
* Update: Verified that the plugin works with newer versions of WordPress up to 4.7.3.
* Update: [Geo Mashup](http://geomashup.org/?utm_source=snazzymaps&utm_medium=plugin&utm_campaign=partners) is now a compatible plugin.
* Deprecated: Renamed enqueue_script to snazzy_enqueue_script.
